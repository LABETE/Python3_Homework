...
class TestAddresses(unittest.TestCase): 
    ...
    def test_initialization(self):
        self.assertRaises(StateError, Address, name='Steve Holden', street_address='1972 Flying Circus', city='Arlington', state='state', zip_code='12345')
        self.assertRaises(ZipCodeError, Address, name='Steve Holden', street_address='1972 Flying Circus', city='Arlington', state='VA', zip_code='123456')
